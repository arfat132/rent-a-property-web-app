    ...
    return (
        <>
            <div id='contact' className='mx-4'>
                ...
                <div className="lg:mt-[-480px] mt-16  mb-20 mr-12 lg:w-2/5 md:w-1/1 bg-gray-50 border border-gray-200 flex flex-col md:ml-auto w-full md:py-8 shadow-lg p-8">
